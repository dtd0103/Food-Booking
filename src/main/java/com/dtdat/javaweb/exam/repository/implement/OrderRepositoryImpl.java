...
public class OrderRepositoryImpl implements OrderRepository {
    ...
    public List<Order> getOrders(String status, Integer orderId, LocalDateTime startDate, LocalDateTime endDate, int offset, int limit, String sortBy, String sortDir) {
        return orderMapper.getOrders(status, orderId, startDate, endDate, offset, limit, sortBy, sortDir);
    }

    public int countOrders(String status, Integer orderId, LocalDateTime startDate, LocalDateTime endDate) {
        return orderMapper.countOrders(status, orderId, startDate, endDate);
    }
